In this proyect, the two views one have an html with a list of items in pokemon, where if you click the type of pokemon shown at the headers, it will give you a list of the items 
